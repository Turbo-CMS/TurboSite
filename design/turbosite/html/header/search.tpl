...
<div id="title-search" class="search-wrapper relative">
	<form action="{$lang_link}search" class="search search--hastype">
		...
		<div class="search-button-div">
			...
			<div class="dropdown-select dropdown-select--with-dropdown searchtype">
				<div class="dropdown-select__title font_14 font_large fill-dark-light banner-light-text">
					<span>
						{if isset($smarty.cookies.searchtitle_type) && $smarty.cookies.searchtitle_type == 'blog'}
						...
						{elseif isset($smarty.cookies.searchtitle_type) && $smarty.cookies.searchtitle_type == 'projects'}
							{$lang->global_projects|escape}
						{else}
				...
				<div class="dropdown-select__list dropdown-menu-wrapper" role="menu">
					<div class="dropdown-menu-inner rounded-x">
						<div class="dropdown-select__list-item font_15">
							<span class="dropdown-menu-item color_222 dropdown-menu-item--current" data-type="all">
						...
						<div class="dropdown-select__list-item font_15">
							<span class="dropdown-menu-item dark_link" data-type="projects">
								<span>{$lang->by_projects|escape}</span>
							</span>
						</div>
					</div>
				</div>
