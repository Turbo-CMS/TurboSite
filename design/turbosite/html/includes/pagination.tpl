		...
		<div class="module-pagination__wrapper">
			<div class="arrows-pagination hide-600">
				{if $current_page_num == 2}
					<a href="{url page=null}" class="arrows-pagination__prev arrows-pagination__item rounded-x" title="{$lang->previous|escape}">
				...
				{if $current_page_num > 2}
					<a href="{url page=$current_page_num - 1}" class="arrows-pagination__prev arrows-pagination__item rounded-x" title="{$lang->previous|escape}">
						<span class="arrow-all arrow-all--reverce arrow-all--wide arrow-all--sm stroke-theme-target">
							<i class="svg inline stroke-dark-light" aria-hidden="true">
								<svg width="7" height="12">
									<use xlink:href="design/{$settings->theme|escape}/images/svg/sprite/arrows.svg#left-7-12"></use>
				...
				{if $current_page_num < $total_pages_num}
					<a href="{url page=$current_page_num + 1}" class="arrows-pagination__next arrows-pagination__item rounded-x" title="{$lang->next|escape}">
			...
			<a href="{url page=all}" class="module-pagination__item">{$lang->global_all|escape}</a>
		</div>
	</div>
{/if}