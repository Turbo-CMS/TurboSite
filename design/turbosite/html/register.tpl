					...
					<div class="breadcrumbs swipeignore" itemscope="" itemtype="http://schema.org/BreadcrumbList">
						...
						{else}
							<span class="breadcrumbs__item" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
								...
								<span>
									<span itemprop="name" class="breadcrumbs__item-name font_13">{$lang->registration|escape}</span>
									<meta itemprop="position" content="{$level++}">
								</span>
							</span>
						{/if}
							...
							<form id="registraion-page-form" class="validate" method="post" name="regform" enctype="multipart/form-data" novalidate="novalidate">
								<div class="form-body">
									<div class="form-group fill-animate">
										<label class="font_14" for="input_NAME">{$lang->name|escape} <span class="required-star">*</span></label>
										<div class="input">
											<input size="30" type="text" id="input_NAME" name="name" required="" value="{$name|escape}" class="form-control" maxlength="255" aria-required="true">
										</div>
									</div>
									<div class="form-group fill-animate">
										<label class="font_14" for="input_EMAIL">E-mail <span class="required-star">*</span></label>
										<div class="input">
											<input size="30" type="email" id="input_EMAIL" name="email" required="" value="{$email|escape}" class="form-control" aria-required="true">
										</div>
										<div class="text_block font_13">
											{$lang->registraion_login_text|escape}
										</div>
									</div>
									<div class="form-group fill-animate">
										<label class="font_14" for="input_PERSONAL_PHONE">{$lang->phone|escape}</label>
										<div class="input">
											<input size="30" type="text" id="input_PERSONAL_PHONE" name="phone" class="form-control phone_input" value="{$phone|escape}">
										</div>
										<div class="text_block font_13"></div>
									</div>
									<div class="form-group fill-animate ">
										<label class="font_14" for="input_PASSWORD">{$lang->password|escape} <span class="required-star">*</span></label>
										...
										<div class="text_block font_13">
											{$lang->registraion_password_text|escape}
										</div>
									</div>
								...
								<div class="form-footer">
									<button class="btn btn-default btn-lg btn-wide" type="submit" name="register" value="{$lang->registration|escape}">
										{$lang->register|escape}
									</button>
