...
{* Bootstrap *}
{if $module == 'BlogView' && isset($post) || $module=='ArticlesView' && isset($post) || $module=='ProjectsView' && isset($project) || $module == 'PageView'}
...
{* Post *}
{if $module == 'BlogView' && isset($post) || $module=='ArticlesView' && isset($post) || $module=='ProjectsView' && isset($project)}
	{css id="post" include=[
