										...
										<ul class="map-level-0">
											<li class="item item-level-0">
												<div class="map-columns__link-wrapper">
													<a class="dark_link title-block font_18" href="{$lang_link}company">{$lang->company}</a>
												</div>
											...
											<li class="item item-level-0">
												<div class="map-columns__link-wrapper">
													<a class="dark_link title-block font_18" href="{$lang_link}services">{$lang->services}</a>
												</div>
												<ul class="map-columns__dropdown map-level-1">
													{foreach $pages as $p2}
									...
									<td class="col-md-6 col-sm-4 col-xs-6 mobile-column">
										<ul class="map-level-0">
											...
											{if $projects_cats}
												<li class="item item-level-0">
													<div class="map-columns__link-wrapper">
														<a class="dark_link title-block font_18" href="{$lang_link}projects">{$lang->global_projects}</a>
													</div>
													<ul class="map-columns__dropdown map-level-1">
