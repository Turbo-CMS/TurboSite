										...
										<ul class="map-level-0">
											<li class="item item-level-0">
												<div class="map-columns__link-wrapper">
													<a class="dark_link title-block font_18" href="{$lang_link}company">{$lang->company|escape}</a>
												</div>
											...
											<li class="item item-level-0">
												<div class="map-columns__link-wrapper">
													<a class="dark_link title-block font_18" href="{$lang_link}services">{$lang->services|escape}</a>
												</div>
												<ul class="map-columns__dropdown map-level-1">
													{foreach $pages as $p2}
									...
									<td class="col-md-6 col-sm-4 col-xs-6 mobile-column">
										<ul class="map-level-0">
											...
											{if $projects_cats}
												<li class="item item-level-0">
													<div class="map-columns__link-wrapper">
														<a class="dark_link title-block font_18" href="{$lang_link}projects">{$lang->global_projects|escape}</a>
													</div>
													<ul class="map-columns__dropdown map-level-1">
														{foreach $projects_cats as $cat}
															{if $cat->visible}
																<li class="item item-level-1">
																	<div class="map-columns__link-wrapper">
																		<a class="dark_link" href="{$lang_link}projects/{$cat->url}">{$cat->name}</a>
																		...
																		<ul class="map-columns__dropdown map-level-2 hidden-block">
																			{foreach $cat->subcategories as $subcat}
																				{if $subcat->visible}
																					<li class="item item-level-2">
																						<div class="map-columns__link-wrapper">
																							<a class="dark_link" href="{$lang_link}projects/{$subcat->url}">{$subcat->name}</a>
																							{if $subcat->subcategories || $subcat->projects}
																								<i class="svg inline svg-inline- map-columns__dropdown-right-arrow bg-theme-hover fill-dark-light-block" aria-hidden="true">
																									<svg width="3" height="5" viewBox="0 0 3 5" fill="none" xmlns="http://www.w3.org/2000/svg">
																										<path d="M3 2.5L0 5L0 0L3 2.5Z" fill="#333333"></path>
																									</svg>
																							...
																							<ul class="map-columns__dropdown map-level-3 hidden-block">
																								{foreach $subcat->subcategories as $subcat3}
																									{if $subcat3->visible}
																										<li class="item item-level-3">
																											<div class="map-columns__link-wrapper">
																												<a class="dark_link" href="{$lang_link}projects/{$subcat3->url}">{$subcat3->name}</a>
																												{if $subcat3->projects}
																													<i class="svg inline svg-inline- map-columns__dropdown-right-arrow bg-theme-hover fill-dark-light-block" aria-hidden="true">
																														<svg width="3" height="5" viewBox="0 0 3 5" fill="none" xmlns="http://www.w3.org/2000/svg">
																															<path d="M3 2.5L0 5L0 0L3 2.5Z" fill="#333333"></path>
																											...
																											{if $subcat3->projects}
																												<ul class="map-columns__dropdown map-level-3 hidden-block">
																													{if $subcat3->projects}
																														{foreach $subcat3->projects as $project}
																															{if $project->visible}
																																<li class="item item-level-3">
																																	<div class="map-columns__link-wrapper">
																																		<a class="dark_link font_14" href="{$lang_link}project/{$project->url}">{$project->name}</a>
																																	</div>
																																</li>
																															{/if}
																														{/foreach}
																								...
																								{/foreach}
																								{if $subcat->projects}
																									{foreach $subcat->projects as $project}
																										{if $project->visible}
																											<li class="item item-level-3">
																												<div class="map-columns__link-wrapper">
																													<a class="dark_link font_14" href="{$lang_link}project/{$project->url}">{$project->name}</a>
