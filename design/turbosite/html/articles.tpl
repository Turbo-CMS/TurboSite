			...
			<div class="col-md-12 col-sm-12 col-xs-12 content-md">
				<div class="right_block narrow_Y">
					<div class="blog-list blog-list--items-offset blog-list-template">
						<div class="js_append grid-list grid-list--items-{$theme_settings->articles_grid_type}-1200 grid-list--items-2-992 grid-list--items-2-768 grid-list--items-1-601 grid-list--gap-row-40 grid-list--normal">
										...
										<div class="blog-list__item-text-wrapper flex-grow-1 flexbox">
											<div class="blog-list__item-text-top-part flexbox">
												<div class="blog-list__item-title switcher-title font_weight--500 font_16">
													<a class="dark_link" href="{$lang_link}article/{$post->url}">
												...
												<div class="blog-list__item-text-bottom-part">
													{if $post->category->name}
														<div class="blog-list__item-section font_14">
															<a class="dark_link" href="{$lang_link}articles/{$post->category->url}">
																{$post->category->name}
															</a>
														</div>
											...
											<div class="line-block line-block--6 line-block--6-vertical line-block--flex-wrap">
												{foreach $all_tags as $tag}
													<div class="line-block__item">
														<a href="{$lang_link}articles/?keyword={$tag}" rel="nofollow" class="bordered chip chip--transparent {if $keyword == $tag}selected{/if}">
