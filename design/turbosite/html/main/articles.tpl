...
{if $last_articles}
	<div class="drag-block container ARTICLES" data-class="articles_drag" data-order="{$theme_settings->block_6}">
										...
										<div class="blog-list__item-text-top-part flexbox">
											<div class="blog-list__item-title switcher-title font_weight--500 font_16">
												<a class="dark_link color-theme-target" href="{$lang_link}article/{$article->url}">
													<span data-article="{$article->id}">{$article->name|escape}</span>
												</a>
											</div>
