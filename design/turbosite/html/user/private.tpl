...
<div class="personal__block personal__block--private">
	<div class="form">
		<div class="personal__top-form bordered outer-rounded-x">
			<h5>{$lang->contact_details_user}</h5>
			<form id="profile-form" class="validate" method="post">
				<div class="form-body form-body--grid">
					<div class="form-group input-filed">
						<label for="NAME" class="font_14"><span>{$lang->name}&nbsp;<span class="required-star">*</span></span></label>
						<div class="input">
					...
					<div class="form-group input-filed">
						...
						<div class="text_block font_13">{$lang->user_email_text}</div>
					</div>
					<div class="form-group input-filed">
						<label for="PERSONAL_PHONE" class="font_14"><span>{$lang->phone}&nbsp;</span></label>
						<div class="input">
							<input type="text" name="phone" id="PERSONAL_PHONE" class="form-control" maxlength="255" value="{$phone|escape}" aria-required="true">
						</div>
						<div class="text_block font_13">{$lang->user_phone_text}</div>
					</div>
				</div>
				<div class="form-footer form-footer--has-message">
					<button class="btn btn-default btn-lg has-ripple" type="submit" name="save" value="save"><span>{$lang->save_changes}</span></button>
				</div>
			</form>
		</div>
		<div class="personal__top-form bordered outer-rounded-x" id="change-password">
			<h5>{$lang->change_password}</h5>
			<form id="pass-form" method="post" class="pass-form">
				...
				<div class="form-body form-body--grid">
					<div class="form-group">
						<label for="NEW_PASSWORD" class="font_14"><span>{$lang->new_password}&nbsp;</span></label>
						...
						<div class="text_block font_13">{$lang->registraion_password_text}</div>
					</div>
				</div>
				<div class="form-footer form-footer--has-message">
					<button class="btn btn-default btn-lg" type="submit" name="save" value="{$lang->save_changes}"><span>{$lang->save_changes}</span></button>
				</div>
			</form>
		</div>
	</div>
