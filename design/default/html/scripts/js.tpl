...
{if $module=='ProjectsView' && $project}
    {js id="project" priority=99 include=["design/{$settings->theme|escape}/js/projects/project.js"]}{/js}
    {javascript minify=true}
{/if}
...
{* Description *}
{if $module == 'BlogView' && $post || $module=='ArticlesView' && $post || $module=='PageView'}
