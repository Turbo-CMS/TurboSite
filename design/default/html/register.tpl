		...
		<div class="card-body">
			<form class="needs-validation" role="form" autocomplete="off" method="post" novalidate>
				...
				<div class="mt-1">
					...
					<button type="submit" class="btn btn-success btn-lg float-end" name="register" value="{$lang->send|escape}"><i class="fa-light fa-user me-2"></i>{$lang->send|escape}</button>
				</div>
			</form>
		</div>
	</div>
