			...
			{if $keyword}
				{if $posts || $pages_search || $articles || $projects}
					...
					{foreach $projects as $project}
						<div class="search-item mt-3">
							<h4 class="mb-1"><a data-project="{$project->id}"  class="text-decoration-none" href="{$lang_link}project/{$project->url}">{$project->name|escape}</a></h4>
							<div class="font-13 mb-3">{$config->root_url}/{$lang_link}project/{$project->url}</div>
