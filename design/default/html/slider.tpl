			...
			{foreach $banner_1->items as $s name=foo}
				<div class="carousel-item {if $smarty.foreach.foo.first}active{/if}">
					<div class="row align-items-center py-3">
						<div class="col-md-6">
							<div class="ps-3 pe-3 ps-md-5 pe-md-0 pt-4 pt-lg-5 pb-3 text-center text-md-start">
						...
						<div class="col-md-6"><img class="d-block mx-auto" src="{$s->image|resize_banners:550:440}" alt="{$s->alt|escape}" title="{$s->title|escape}"></div>
					</div>
				</div>
			{/foreach}
		</div>
