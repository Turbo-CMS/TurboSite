	...
	<div class="container text-center text-md-start">
		<div class="row text-center text-md-start">
			...
			<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
				<h6 class="text-uppercase mb-4 font-weight-bold">{$lang->help|escape}</h6>
				{foreach $pages as $p}
			...
			<div class="col-md-6 col-lg-6 ml-lg-0">
				...
				<div class="text-center text-md-end">
					<ul class="list-unstyled list-inline">
						...
						<li class="list-inline-item">
							<a class="btn-floating btn-sm rgba-white-slight mx-1" href="{$config->root_url}/{$lang_link}rss.xml" target="_blank">
								<i class="fa fa-rss"></i>
							</a>
						</li>
						<li class="list-inline-item">
