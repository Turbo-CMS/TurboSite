...
{if isset($total_pages_num) && $total_pages_num>1}
	<nav aria-label="pageNavigation">
		<ul class="pagination justify-content-center">
			...
			{if $current_page_num==2}<li class="page-item"><a class="page-link" href="{url page=null}"><i class="fal fa-chevron-left"></i></a></li>{/if}
			{if $current_page_num>2}<li class="page-item"><a class="page-link" href="{url page=$current_page_num-1}"><i class="fal fa-chevron-left"></i></a></li>{/if}
