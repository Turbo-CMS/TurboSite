...
class IndexAdmin extends Turbo
{
	private $modulesPermissions = [
		...
		'ArticlesAdmin'             => 'blog',
		'ArticleAdmin'              => 'blog',
		'ProjectsCategoriesAdmin'   => 'projects',
		'ProjectsCategoryAdmin'     => 'projects',
	...
	function fetch()
	{
		...
		$totalCounter = $newCommentsCounter + $newFeedbacksCounter + $newCallbacksCounter + $newSubscribesCounter;
