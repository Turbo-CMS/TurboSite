				...
				<div class="collapse-card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-xl-3 col-lg-4 col-md-6">
								<div class="mb-3">
									<div class="form-label"> {$btr->comments_tree_projects|escape}</div>
									<select name="comments_tree_projects" class="selectpicker">
										<option value="on" {if $settings->comments_tree_projects == "on"}selected{/if}>{$btr->global_do_enable|escape}</option>
										<option value="off" {if $settings->comments_tree_projects == "off"}selected{/if}>{$btr->global_do_disable|escape}</option>
									</select>
								</div>
							</div>
						</div>
