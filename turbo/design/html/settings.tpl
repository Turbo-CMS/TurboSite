                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="row">
                        <div class="col-lg-2 col-md-6">
                            <div class="heading_label">{$btr->settings_catalog_projects_on_page|escape}</div>
                            <div class="mb-1">
                                <input name="projects_num" class="form-control" type="text" value="{$settings->projects_num|escape}" />
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="heading_label">{$btr->settings_catalog_projects_on_admin|escape}</div>
                            <div class="mb-1">
            ...
            <div class="boxed fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="heading_label"> {$btr->comments_tree_projects|escape}</div>
                            <div class="mb-1">
                                <select name="comments_tree_projects" class="selectpicker">
                                    <option value="on" {if $settings->comments_tree_projects == "on"}selected{/if}>{$btr->settings_general_turn_on|escape}</option>
                                    <option value="off" {if $settings->comments_tree_projects == "off"}selected{/if}>{$btr->settings_general_turn_off|escape}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="permission_boxes row">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="permission_box">
                                    <span>{$btr->settings_general_project|escape}</span>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" id="captcha_project" name="captcha_project" value="1" type="checkbox" {if $settings->captcha_project}checked="" {/if}>
                                        <label class="form-check-label" for="captcha_project"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
