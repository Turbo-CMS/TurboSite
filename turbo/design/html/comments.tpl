    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                ...
                {elseif $type=='project'}
                    {$btr->general_comments} {$btr->comments_to_project_small|escape} - {$comments_count}
                {elseif $type=='blog'}
                    {$btr->general_comments} {$btr->comments_to_news_small|escape} - {$comments_count}
                {elseif $type=='article'}
                    {$btr->general_comments} {$btr->comments_to_article_small|escape} - {$comments_count}
                {elseif $type=='review'}
                                    ...
                                    <div class="fn_row turbo_list_body_item {if !$comment->approved}unapproved{/if} {if $level > 0}admin_note2{/if}">
                                        <div class="turbo_list_row">
                                            ...
                                            <div class="turbo_list_boding turbo_list_comments_name {if $level > 0}admin_note{/if}">
                                                ...
                                                <a class="comment_object text_spacing" href="index.php?module=CommentsAdmin&item_id={$comment->object_id}&type={$comment->type}">{$btr->all_comments_to_object|escape}</a>
