		...
		<div class="col-md-12">
			<div class="boxed fn_toggle_wrap min_height_230px">
				...
				<div class="toggle_body_wrap fn_card on">
					<div class="row">
						<div class="col-lg-4 col-md-6 pr-0 pr-lg-0">
						 ...
						 <div class="col-lg-4 col-md-6 pr-0">
                            <div class="banner_card">
                                <div class="banner_card_header">
                                    <span class="font-weight-bold">{$btr->project_categories|escape}:</span>
                                </div>
                                <div class="banner_card_block">
                                    <select name="projects_categories[]" class="selectpicker" multiple="multiple" data-selected-text-format="count">
                                        <option value='0' {if !$banner->projects_category_selected || 0|in_array:$banner->projects_category_selected}selected{/if}>{$btr->banner_hide|escape}</option>
                                        {function name=category_select level=0}
                                            {foreach from=$projects_categories item=category}
                                                ...
                                                {category_select projects_categories=$category->subcategories selected=$banner->projects_category_selected  level=$level+1}
                                            {/foreach}
                                        {/function}
                                        {category_select projects_categories=$projects_categories selected=$banner->projects_category_selected}
                                    </select>
                                </div>
                            </div>
                        </div>
						<div class="col-lg-4 col-md-6 pr-lg-0">
							<div class="banner_card">
								<div class="banner_card_header">
