									...
									<div class="alert alert-primary alert-dismissible" role="alert">
										<div class="alert-message p-4">
											...
											<ul class="mb-0 ps-3">
												...
												<li class="mb-1"><strong>{ldelim}project{rdelim} </strong> - {$btr->global_project_name|escape}</li>
						...
						<div class="row">
							<div class="col-lg-5 col-md-12">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="mb-3">
											<div class="form-label">{$btr->seo_projects|escape}</div>
							...
							<div class="col-lg-5 col-md-12">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="mb-3">
											<div class="form-label">{$btr->seo_projects|escape}</div>
											<textarea name="project_meta_description" class="form-control turbo-textarea">{$seo->project_meta_description|escape}</textarea>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3">
