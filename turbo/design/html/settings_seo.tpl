                                            ...
                                            <div class="text_box">
                                                <div>
                                                    <ul class="mb-0 pl-1">
                                                        ...
                                                        <li><label class="property">{ldelim}project{rdelim} </label> - {$btr->seo_patterns_ajax_project_name|escape}</li>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="heading_label">{$btr->seo_projects|escape}</div>
                                    <div class="mb-1">
                                        <input name="project_meta_title" class="form-control mb-h" type="text" value="{$seo->project_meta_title|escape}" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <div class="boxed boxed_attention">
                                            ...
                                            <div class="text_box">
                                                <div class="mb-1">
                                                    ...
                                                    {$btr->seo_patterns_ajax_message2|escape} <b style="display: inline;">{ldelim}$project{rdelim}</b> {$btr->seo_patterns_ajax_message3|escape}
                                                </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="heading_label">{$btr->seo_projects|escape}</div>
                                    <div class="mb-1">
                                        <input name="project_meta_keywords" class="form-control mb-h" type="text" value="{$seo->project_meta_keywords|escape}" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="heading_label">{$btr->left_pages|escape}</div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="heading_label">{$btr->seo_projects|escape}</div>
                                    <div class="mb-1">
                                        <textarea name="project_meta_description" class="form-control turbo_textarea">{$seo->project_meta_description|escape}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="heading_label">{$btr->left_pages|escape}</div>
