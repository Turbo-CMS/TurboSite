        ...
        <div class="wrap_heading">
            ...
            {if $post->id}
                <div class="box_btn_heading">
                    <a class="btn btn_small btn-primary add" target="_blank" href="../{$lang_link}article/{$post->url}">
            ...
            <div class="boxed match_matchHeight_true">
                <div class="row d_flex">
                    <div class="col-lg-10 col-md-9 col-sm-12">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="author" type="text" value="{$post->author|escape}" />
                        </div>
                        <div class="row">
            ...
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <ul class="post_images_list">
                        <li class="post_image_item border_image_item {if $post->image}border{/if}">
                            {if $post->image}
                                ...
                                <div class="fn_parent_image2">
                                    <div class="image_wrapper fn_image_wrapper2 text-xs-center">
                                        ...
                                        <img src="{$post->image|resize_articles:180:100}" alt="" />
                                    </div>
                                </div>
                            {else}
