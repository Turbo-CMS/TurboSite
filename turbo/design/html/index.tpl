					...
					<ul class="menu_items">
						...
						{if in_array('projects', $manager->permissions)}
							<li class="{if in_array($smarty.get.module, array("ProjectsCategoriesAdmin","ProjectsAdmin","ProjectAdmin","ProjectsCategoryAdmin"))}open active{/if} fn_item_sub_switch nav-dropdown">
								<a class="nav-link fn_item_switch nav-dropdown-toggle" href="javascript:;">
									<span class="icon-thumbnail">
										{include file='svg_icon.tpl' svgId='projects'}
									</span>
						...
						{if in_array('settings', $manager->permissions) || in_array('managers', $manager->permissions) || in_array('languages', $manager->permissions)}
							<li class="{if in_array($smarty.get.module, array("SettingsAdmin","ManagersAdmin","ManagerAdmin","LanguagesAdmin","LanguageAdmin","SystemAdmin"))}open active{/if} fn_item_sub_switch nav-dropdown">
								<a class="nav-link fn_item_switch nav-dropdown-toggle" href="javascript:;">
									<span class="icon-thumbnail">
