			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
						...
						<li class="sidebar-item {if in_array($smarty.get.module, array('ProjectsCategoriesAdmin', 'ProjectsAdmin', 'ProjectAdmin', 'ProjectsCategoryAdmin'))}active{/if}">
							...
							<ul id="projects" class="sidebar-dropdown list-unstyled collapse {if in_array($smarty.get.module, array('ProjectsCategoriesAdmin', 'ProjectsAdmin', 'ProjectAdmin', 'ProjectsCategoryAdmin'))}show{/if}" data-bs-parent="#sidebar">
								<li class="sidebar-item {if in_array($smarty.get.module, array('ProjectsCategoriesAdmin', 'ProjectsCategoryAdmin'))}active{/if}">
									<a class="sidebar-link" href="index.php?module=ProjectsCategoriesAdmin">{$btr->categories_projects|escape}</a>
								</li>
					...
					{if in_array('backup', $manager->permissions)}
						<li class="sidebar-item {if isset($smarty.get.module) && in_array($smarty.get.module, array('BackupAdmin', 'ClearAdmin'))}active{/if}">
							<a data-bs-target="#auto" data-bs-toggle="collapse" {if isset($smarty.get.module) && in_array($smarty.get.module, array('BackupAdmin', 'ClearAdmin'))}class="sidebar-link" aria-expanded="true" {else}class="sidebar-link collapsed" aria-expanded="false" {/if}>
								<i class="align-middle" data-feather="repeat"></i>
								<span class="align-middle">{$btr->global_automation|escape}</span>
							</a>
							<ul id="auto" class="sidebar-dropdown list-unstyled collapse {if isset($smarty.get.module) && in_array($smarty.get.module, array('BackupAdmin', 'ClearAdmin'))}show{/if}" data-bs-parent="#sidebar">
								{if in_array('backup', $manager->permissions)}
					...
					{if in_array('settings', $manager->permissions) || in_array('currency', $manager->permissions) || in_array('delivery', $manager->permissions) || in_array('payment', $manager->permissions) || in_array('managers', $manager->permissions) || in_array('languages', $manager->permissions)}
						<li class="sidebar-item {if isset($smarty.get.module) && in_array($smarty.get.module, array('SettingsAdmin', 'ManagersAdmin', 'ManagerAdmin', 'SettingsFeedAdmin', 'LanguagesAdmin', 'LanguageAdmin', 'SystemAdmin'))}active{/if}">
							<a data-bs-target="#settings" data-bs-toggle="collapse" {if isset($smarty.get.module) && in_array($smarty.get.module, array('SettingsAdmin', 'ManagersAdmin', 'ManagerAdmin', 'SettingsFeedAdmin', 'LanguagesAdmin', 'LanguageAdmin', 'SystemAdmin'))}class="sidebar-link" aria-expanded="true" {else}class="sidebar-link collapsed" aria-expanded="false" {/if}>
								<i class="align-middle" data-feather="settings"></i>
								<span class="align-middle">{$btr->global_settings|escape}</span>
							</a>
							<ul id="settings" class="sidebar-dropdown list-unstyled collapse {if isset($smarty.get.module) && in_array($smarty.get.module, array('SettingsAdmin', 'ManagersAdmin', 'ManagerAdmin', 'SettingsFeedAdmin', 'LanguagesAdmin', 'LanguageAdmin', 'SystemAdmin'))}show{/if}" data-bs-parent="#sidebar">
					...
					{/if}
					{if in_array('rss', $manager->permissions)}
						<li class="sidebar-item">
							<a class="sidebar-link" target="_blank" href="{$config->root_url}/{$lang_link}rss.xml">
								<i class="align-middle" data-feather="rss"></i> <span class="align-middle">{$btr->global_rss|escape}</span>
							</a>
						</li>
					{/if}
				</ul>
					...
					for (var i = 0; i < el.length; i++) {
						var sortable = Sortable.create(el[i], {
							...
							onUpdate: function(evt) {
								if ($(".project-images-list").length > 0) {
									var itemEl = evt.item;
