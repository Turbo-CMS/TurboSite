        ...
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-1">
                                                        <textarea name="counters[code][]" class="form-control turbo_textarea">{$c->code|escape}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="fn_new_counter hidden fn_row mt-1">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="heading_label">{$btr->counters_counter_code|escape}</div>
                                        <div class="mb-1">
                                            <textarea name="counters[code][]" class="form-control turbo_textarea"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box_btn_heading mt-1 mb-1">
                        <button type="button" class="btn btn_mini btn-success fn_add_counter">
