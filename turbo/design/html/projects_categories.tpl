											...
											<div class="turbo-list-row {if $level > 1}js-sort-item{/if} narrow">
												...
												<div class="turbo-list-boding turbo-list-status">
													<div class="form-check form-switch">
														<input class="form-check-input js-ajax-action {if $category->visible}js-active-class{/if}" id="id-{$category->id}" data-module="projects_category" data-action="visible" data-id="{$category->id}" name="visible" value="1" type="checkbox" {if $category->visible}checked="" {/if}>
