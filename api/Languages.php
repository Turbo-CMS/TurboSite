...
class Languages extends Turbo
{
    ...
    public $tables = array(
        ...
        'project'          => 'projects',
        'project_category' => 'projects_categories'
    );
    ...
    public function get_fields($object = '')
    {
        ...
        $fields['projects']                    = array('name', 'meta_title', 'meta_keywords', 'meta_description', 'annotation', 'text', 'client', 'type');
        $fields['projects_categories']      = array('name', 'name_h1', 'meta_title', 'meta_keywords', 'meta_description', 'description');
    ...
    public function count_translations($filter = array())
    {
        ...
        $query = $this->db->placehold("SELECT count(distinct id) as count
										FROM __translations  WHERE 1 $keyword_filter");
